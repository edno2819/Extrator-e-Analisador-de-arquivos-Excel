...
class Site:
    LOGIN_LINK ='http://politicanacional.simpress.com.br/RelatorioRevenda/Index'
    input_revenda = (By.XPATH, '//input[@class="textBox text bloco ui-autocomplete-input"]')
    input_dates = (By.XPATH, '//a[@class="chosen-single chosen-default"]')
    dates =  (By.XPATH, '(//ul[@class="chosen-results"]//li[@class="active-result"])[1]')
    ...
    def teste(self):
        self.driver.start()
        self.driver.open_page('https://www.sarutaia.sp.gov.br/arquivos/a_pequena_sereia_(hans_christian_andersen)_01100246.pdf') 
